    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnFire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("onClick", "Button is Clicked");
                mMap.clear();
                String url = getUrl(latitude, longitude, fires);
                Object[] DataTransfer = new Object[2];
                DataTransfer[0] = mMap;
                DataTransfer[1] = url;
                Log.d("onClick", url);
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Fire Station", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnBus.setOnClickListener(new View.OnClickListener() {
            String Bus = "bus stop|bus station";
            @Override
            public void onClick(View v) {
                Log.d("onClick", "Button is Clicked");
                mMap.clear();
        ...
        btnRailway.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Railway Station", Toast.LENGTH_LONG).show();
            }
        });
